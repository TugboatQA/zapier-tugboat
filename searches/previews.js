const perform = (z, bundle) => {
  ...
  return z.request(options).then((response) => {
    ...
    if (!bundle.inputData.ref) {
      return results;
    }
    return results.filter((preview) => preview.ref === bundle.inputData.ref);
  });
};
...
module.exports = {
  operation: {
    ...
    inputFields: [
      ...
      },
      {
        ...
        required: false,
        list: false,
        helpText: 'Optional. The git ref to find a Preview for. This can be a pull request number, branch, tag, or commit hash',
      },
    ],
    sample: {
      state: 'suspended',
  ...
  display: {
    label: 'Find Previews',
    description: 'Find a Preview or Previews',
    hidden: false,
    important: false,
  },
};
